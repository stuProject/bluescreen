...
<div id="" style="">
    ...
    <hr>
    <form action="/board/fu" id="fudel" name="write" method="post" enctype="multipart/form-data">
      ...
      <input type="hidden" name="division" id="division" value="1"> <!-- 신고 카테고리 ( 0이면 게시글 1이면 댓글) -->
      ...
      <table style="margin: 80px 0 100px 0;">
        <colgroup>
         ...
         <tr>
          ...
          <td style="float:left;">
          <select id = "creason" name = "creason" style="width:50px; height: 52px;"> <!-- id, name 추가 -->
