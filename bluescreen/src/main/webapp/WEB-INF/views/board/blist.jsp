  ...
  <!-- 	<div id="location">
	...
	<div style="width:1000px; margin-right: auto; margin-left:auto;">					
   			<h2 style="margin:150px 0 70px 0; text-align: center;">
   				...
   				<br>
   				<br>
   				<span style="font-size: 15px; color: #888888; font-weight: normal;">게시글 목록</span>
   			</h2>
...
<div class="btnAreaList" style="margin-bottom:300px;">
    ...
    <c:if test="${page > 1}">
      <a href="/board/blist?page=${page-1 }"><li class="prev" style="width:19px;height:27px; line-height:23px; vertical-align:top; margin-right:5px;"></li></a>
    </c:if>
    <c:if test="${page == 1}">
   ...
   <c:if test="${page!= maxPage}">
      <a href="/board/blist?page=${maxPage }"><li class="last1" style="width:25px;height:25px;line-height:23px; vertical-align:top;"></li></a>
   </c:if>
   <c:if test="${page == maxPage}">
